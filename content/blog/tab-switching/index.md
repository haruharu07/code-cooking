...
emoji: 🥕
category: recipe
description: ウェブサイト制作の現場でよく実装する機能のひとつが「タブ切り替え」です。記述自体はそこまで複雑ではないのですが、すこし工夫が必要だったりもします。はじめのうちはコードを書きながら覚えていって、内容を理解したあとはもう使いまわしちゃいましょう！
---

ウェブサイト制作の現場でよく実装する機能のひとつが「タブ切り替え」です。記述自体はそこまで複雑ではないのですが、すこし工夫が必要だったりもします。
はじめのうちはコードを書きながら覚えていって、内容を理解したあとはもう使いまわしちゃいましょう！
...
また、タブを切り替える際に、切り替わったことがわかるように、ちょっとしたアニメーションもつけておくといいかもしれません！JavaScriptではjQueryのようにfadeInメソッドが使えないので、今回はCSSでアニメーションをつくっています。
...
👆 メニューの数の分だけ（3回）処理を繰り返したいので、 for文を使います。
